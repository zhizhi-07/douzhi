...
===通讯录
说明：每一行是一个联系人，格式：姓名|||手机号（可打码）|||关系|||最近一次联系的简短说明。
示例（不要照抄，只是说明结构）：
示例：小周|||137****8899|||大学室友|||半夜发消息吐槽老板，让你第二天提醒他别冲动辞职

===微信聊天
说明：这是**最核心、篇幅最大的部分**，要尽量丰富，体现角色真实的社交生活和情绪波动。
...
- 🔥 **每个会话只能和一个人或一个群聊天！** 不要在同一个会话下面混入不同人的对话！
- 🔥 **如果要和另一个人聊天，必须先写新的会话概要行，开启新的会话！**
...
❌ 错误：小王|||在吗|||刚刚|||2
❌ 错误：对话：self|||在吗|||23:15
❌ 错误：对话：other|||在的|||23:16  ← 这里还是和小王聊
❌ 错误：对话：self|||今天天气真好|||23:20  ← 突然变成和另一个人聊了？这是错的！

✅ 正确：应该分成两个会话：
✅ 正确：小王|||在吗|||刚刚|||2
✅ 正确：对话：self|||在吗|||23:15
✅ 正确：对话：other|||在的|||23:16
✅ 正确：小李|||今天天气真好|||23:20|||1  ← 新的会话概要行
✅ 正确：对话：self|||今天天气真好|||23:20
