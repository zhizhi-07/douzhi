...
- 关系判断依据：各自和用户的聊天记录
- 考虑最近的聊天情绪和互动状态
- 每条评论/私聊都要像真实朋友圈的说话方式：句子短、口语化，可以只回一个字或一个emoji，不要写成长篇分析报告
- 不要在内容里说“根据设定/根据提示词/作为AI/我要执行指令”等元话，只输出角色本人会说的话
- 并不是所有角色都必须有动作，有些人完全沉默是正常的，请根据关系和人设决定谁会互动
