...
- 私聊是私下的，不会在评论区显示
- **数量要求**：必须生成 1-3 条私聊！
- **发送者**：从AI角色中选择1-3个合适的角色发私聊
- **触发场景**：任何帖子都应该有AI角色私下关心或互动
...
- 如果帖子涉及情感 → 发关心或安慰
- 如果帖子是炫耀 → 发祝贺或羡慕
- 如果帖子@了某人 → 被@的人可以私聊询问详情

**私聊内容要求：**
- 符合角色人设和语气
- 内容简短自然（10-50字）
- 可以是：问候、关心、调侃、分享、约饭、闲聊等
- 避免太正式或太刻意
- 可以自然地提到在论坛看到帖子，如："刚在论坛看到你发的"、"看到你在 http://localhost:3000/instagram/create 发的帖子"等
...
[回复] 网友A -> 汁汁：你谁啊
[回复] 汁汁 -> 网友A：关你什么事
[私聊] 汁汁：刚在 http://localhost:3000/instagram/create 看到你发的，有意思啊
[私聊] 小美：看到你的帖子了，最近怎么样？
[私聊] 阿强：论坛上看到了，晚上有空聊聊吗
