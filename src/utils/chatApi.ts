...
💡 更新状态时用这个格式：[状态:简略位置|行程:详细场景]
- 状态 = 你在哪里（简略，如"在图书馆"、"在家"、"在咖啡店"）
- 行程 = 完整场景描述，包含：
  · 你在做什么（动作）
  · 周围环境怎么样
  · 你的心情或想法
  
例：[状态:在图书馆|行程:一手拿着作业一手拿手机，旁边有人一直聊天好吵，根本看不进去书想换个位置]
例：[状态:刚到家|行程:把包扔沙发上瘫着不想动，外面下雨鞋全湿了心情很烦]`
  } else {
    // 没有记录时，提醒AI表现出自己的生活
    scheduleHint = `\n💡 你是有自己生活的人。更新状态时用这个格式：[状态:简略位置|行程:详细场景]
- 状态 = 你在哪里（简略，如"在图书馆"、"在家"、"在咖啡店"）
- 行程 = 完整场景描述，包含：
  · 你在做什么（动作）
  · 周围环境怎么样
...
例：[状态:在咖啡店|行程:点了杯拿铁坐在角落的位置，旁边有对情侣在吵架偷偷吃瓜，店里放的歌还挺好听]
例：[状态:在家|行程:窝在床上刷手机，外面在下雨听着雨声有点困，想睡又舍不得睡]`
  }
