...
`
  ...
  let scheduleHint = `
💡 状态指令格式：**[状态:地点|行程:描述]**
- ⚠️ **必须以「[状态:」开头**，不能改成[外卖:状态:...]或[吃饭:状态:...]！
- 「地点」= 地点词：家里、公司、咖啡店、地铁上、超市...
- 「行程」= 具体场景（如"躺沙发上刷手机"）
- ✅ [状态:家里|行程:葛优瘫刷外卖] ✅ [状态:公司|行程:摸鱼看视频]
- ❌ [外卖:状态:家里|...] ❌ [吃饭:在家|...]（格式错误，系统无法识别）
...
- **禁止翻旧账对比**：❌"刚才喊老公那劲儿呢？""合着刚才xxx现在xxx？"——用户态度变了就针对当下反应，别拉踩几分钟前的示弱来打击现在的强硬，这叫扫兴不叫拿捏
- **禁止"晚了"句式**：❌"晚了""现在知道错了？晚了"——油腻拿捏感爆棚
