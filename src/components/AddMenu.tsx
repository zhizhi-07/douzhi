...
const AddMenu = ({
  ...
  const menuItems: MenuItem[] = [
    ...
    // 商城放第二页（第20个，起诉旁边）
    {
      ...
      iconId: 'menu-shop-manager'
    },
    // 默契游戏放第二页（第21个）
    {
      icon: <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01" /></svg>,
      label: '默契',
      onClick: onSelectTacitGame,
      iconId: 'menu-tacit'
    },
  ]
